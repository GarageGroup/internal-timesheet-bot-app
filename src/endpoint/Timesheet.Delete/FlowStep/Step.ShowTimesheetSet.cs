...
partial class DateTimesheetFlowStep
{
    ...
    private static IActivity CreateActivity(IChatFlowContext<DeleteTimesheetFlowState> context)
    {
    ...
    private static IActivity CreateAdaptiveCardActivity(IChatFlowContext<DeleteTimesheetFlowState> context)
        =>
        new Attachment
        {
    ...
    private static List<AdaptiveElement> CreateAdaptiveBody(IChatFlowContext<DeleteTimesheetFlowState> context)
    {
    ...
    private static string BuildText(IChatFlowContext<DeleteTimesheetFlowState> context)
    {
    ...
    private static string BuildTelegramText(IChatFlowContext<DeleteTimesheetFlowState> context)
    {
        var flowState = context.FlowState;
        var textBuilder = new StringBuilder();
    ...
    private static decimal GetDurationSum(this DeleteTimesheetFlowState flowState)
        =>
